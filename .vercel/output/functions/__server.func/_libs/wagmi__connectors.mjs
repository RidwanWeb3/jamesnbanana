import { m as createConnector, C as ChainNotConfiguredError, P as ProviderNotFoundError, J as extractRpcUrls } from "./wagmi__core.mjs";
import { q, K, L } from "./wagmi__core.mjs";
import { g as getAddress, S as SwitchChainError, n as numberToHex, U as UserRejectedRequestError, o as withRetry, q as withTimeout, R as ResourceUnavailableRpcError } from "./viem.mjs";
import "./zustand.mjs";
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await (() => {
          try {
            return import("./base-org__account.mjs");
          } catch {
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await (() => {
          try {
            return import("./coinbase__wallet-sdk.mjs");
          } catch {
  ...
  return createConnector((config) => ({
    ...
    async getAccounts() {
      if (!metamask && !metamaskPromise) {
        ...
        if (injected) {
          const accounts2 = await injected.request({ method: "eth_accounts" });
    ...
    async getChainId() {
      if (!metamask && !metamaskPromise) {
        const injected = config.providers[0]?.provider;
        if (injected) {
          const chainId2 = await injected.request({ method: "eth_chainId" });
      ...
      if (!metamask) {
        if (!metamaskPromise) {
          const { createEVMClient } = await (async () => {
            try {
              return import("../_chunks/connectors_false.mjs");
            } catch {
        ...
        try {
          if (!accounts?.length && !isReconnecting) {
            const { RpcSchema } = await (() => {
              try {
                return import("../_chunks/connectors_false2.mjs");
              } catch {
            ...
            const { z } = await (() => {
              try {
                return import("../_chunks/connectors_false3.mjs");
              } catch {
    ...
    async getProvider() {
      ...
      if (!provider_) {
        const { default: SDK } = await (() => {
          try {
            return import("./safe-global__safe-apps-sdk.mjs").then(function(n) {
              return n.i;
            });
          } catch {
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await (() => {
            try {
              return import("./@safe-global/safe-apps-provider+[...].mjs").then(function(n) {
                return n.i;
              });
            } catch {
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        const { EthereumProvider } = await (() => {
          try {
            return import("../_chunks/connectors_false4.mjs");
          } catch {
