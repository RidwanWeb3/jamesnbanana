...
import { b as isWsUrl, c as isLocalhostUrl, d as formatJsonRpcError, p as parseConnectionError } from "../walletconnect__jsonrpc-utils.mjs";
import { c as cjsExports } from "../walletconnect__environment.mjs";
const v = () => typeof WebSocket < "u" ? WebSocket : typeof global < "u" && typeof global.WebSocket < "u" ? global.WebSocket : typeof window < "u" && typeof window.WebSocket < "u" ? window.WebSocket : typeof self < "u" && typeof self.WebSocket < "u" ? self.WebSocket : require("ws"), w = () => typeof WebSocket < "u" || typeof global < "u" && typeof global.WebSocket < "u" || typeof window < "u" && typeof window.WebSocket < "u" || typeof self < "u" && typeof self.WebSocket < "u", d = (r) => r.split("?")[0], h = 10, b = v();
class f {
  constructor(e) {
    if (this.url = e, this.events = new EventEmitter(), this.registering = false, !isWsUrl(e)) throw new Error(`Provided URL is not compatible with WebSocket connection: ${e}`);
    this.url = e;
  }
  get connected() {
  ...
  register(e = this.url) {
    ...
    return this.url = e, this.registering = true, new Promise((t, n) => {
      const s = cjsExports.isReactNative() ? void 0 : { rejectUnauthorized: !isLocalhostUrl(e) }, o = new b(e, [], s);
      w() ? o.onerror = (i) => {
        const a = i;
...
const require$$12 = /* @__PURE__ */ getAugmentedNamespace(index_es);
export {
  require$$12 as r
};
