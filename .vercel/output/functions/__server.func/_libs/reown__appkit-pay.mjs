import { a as r, i as i$1, n } from "./lit__reactive-element.mjs";
import { T, o, e } from "./lit-html.mjs";
import { i } from "./lit-element.mjs";
import { b as css, c as customElement, U as UiHelperUtil, M as MathUtil } from "./reown__appkit-ui.mjs";
import { a as subscribeKey, b as subscribe, p as proxy } from "./valtio.mjs";
import { C as ConstantsUtil, d as ContractUtil, b as ParseUtil, N as NumberUtil } from "./reown__appkit-common.mjs";
import { P as ProviderController, i as ConnectionController, d as CoreHelperUtil, Q as FetchUtil, O as OptionsController, U as getNativeTokenAddress, C as ChainController, j as AssetUtil, p as EventsController, t as SnackController, J as BalanceUtil, M as ModalController, a as ConnectorController, R as RouterController } from "./reown__appkit-controllers.mjs";
import { H as HelpersUtil } from "./reown__appkit-utils.mjs";
import "./lit-labs__ssr-dom-shim.mjs";
import "./qrcode.mjs";
import "fs";
import "./react.mjs";
import "./encode-utf8.mjs";
import "./dijkstrajs.mjs";
import "./pngjs.mjs";
import "zlib";
import "assert";
import "buffer";
import "util";
import "stream";
import "./proxy-compare.mjs";
import "./dayjs.mjs";
import "./big.js.mjs";
import "./@walletconnect/universal-provider+[...].mjs";
import "./walletconnect__sign-client.mjs";
import "events";
import "./@walletconnect/core.mjs";
import "./walletconnect__heartbeat.mjs";
import "./walletconnect__time.mjs";
import "./tslib.mjs";
import "./walletconnect__events.mjs";
import "./walletconnect__keyvaluestorage.mjs";
import "./unstorage.mjs";
import "./destr.mjs";
import "./idb-keyval.mjs";
import "./walletconnect__safe-json.mjs";
import "./walletconnect__logger.mjs";
import "./walletconnect__types.mjs";
import "./walletconnect__relay-auth.mjs";
import "./walletconnect__utils.mjs";
import "./detect-browser.mjs";
import "./walletconnect__window-getters.mjs";
import "./walletconnect__window-metadata.mjs";
import "./ox.mjs";
import "./abitype.mjs";
import "./zod.mjs";
...
import "./eventemitter3.mjs";
import "./msgpack__msgpack.mjs";
import "./uint8arrays.mjs";
import "./multiformats.mjs";
import "crypto";
import "./walletconnect__relay-api.mjs";
import "./blakejs.mjs";
import "./@walletconnect/jsonrpc-provider+[...].mjs";
import "./walletconnect__environment.mjs";
import "./walletconnect__jsonrpc-utils.mjs";
import "./walletconnect__jsonrpc-types.mjs";
import "./@walletconnect/jsonrpc-ws-connection+[...].mjs";
import "./@walletconnect/jsonrpc-http-connection+[...].mjs";
import "./cross-fetch.mjs";
import "./node-fetch.mjs";
import "http";
import "url";
import "./whatwg-url.mjs";
import "./webidl-conversions.mjs";
import "punycode";
import "./tr46.mjs";
import "https";
import "./reown__appkit-wallet.mjs";
import "./viem.mjs";
import "./isows.mjs";
import "net";
import "tls";
...
let W3mPayView = class W3mPayView2 extends i {
  ...
  templateExchangeOptions() {
    if (this.isLoading) {
      return T`<wui-flex justifyContent="center" alignItems="center">
    ...
    return exchangesToShow.map((exchange) => T`
        <wui-list-item
          type="secondary"
          boxColor="foregroundSecondary"
  ...
  templateSeparator() {
    return T`<wui-separator text="or" bgColor="secondary"></wui-separator>`;
  }
...
let W3mPayLoadingView = class W3mPayLoadingView2 extends i {
  ...
  tokenTemplate() {
    ...
    if (hasTransactionSucceeded) {
      return T`<wui-flex alignItems="center" justifyContent="center">
  ...
  renderStatusIndicator(status) {
    if (status === "completed") {
      return T`<wui-icon size="sm" color="success" name="checkmark"></wui-icon>`;
    }
    if (status === "failed") {
      return T`<wui-icon size="sm" color="error" name="close"></wui-icon>`;
    }
    if (status === "pending") {
      return T`<wui-loading-spinner color="accent-primary" size="sm"></wui-loading-spinner>`;
    }
    return null;
  }
  startPolling() {
  ...
  render() {
    ...
    return T`
      ...
      >
        ...
        ${isUsingExchange ? null : T`<wui-button
              size="md"
      ...
      >
        <wui-flex alignItems="center" gap="2">
          ...
          <wui-flex flexDirection="column" gap="1">
            ...
            ${hasEnoughBalance ? T`<wui-text variant="sm-regular" color="secondary">
                  ${bigAmount.round(6).toString()} ${metadata.symbol}
                </wui-text>` : null}
          </wui-flex>
        </wui-flex>

        ${isSelected ? T`<wui-icon name="checkmark" size="md" color="success"></wui-icon>` : null}
      </wui-flex>
    `;
  }
...
let W3mPayQuoteView = class W3mPayQuoteView2 extends i {
  ...
  paymentOptionsTemplate() {
    ...
    if (this.isFetchingTokenBalances) {
      return T`<w3m-pay-options-skeleton></w3m-pay-options-skeleton>`;
    }
    if (paymentAssets.length === 0) {
      return T`<w3m-pay-options-empty
  ...
  amountWithFeeTemplate() {
    if (this.isFetchingQuote || !this.selectedPaymentAsset || this.quoteError) {
      return T`<w3m-pay-fees-skeleton></w3m-pay-fees-skeleton>`;
    }
    return T`<w3m-pay-fees></w3m-pay-fees>`;
  }
    ...
    return T`
      <wui-flex alignItems="center" justifyContent="space-between">
        <wui-flex flexDirection="column" gap="1">
          ...
          ${isLoading || isDisabled ? T`<wui-shimmer width="58px" height="32px" variant="light"></wui-shimmer>` : T`<wui-flex alignItems="center" gap="01">
