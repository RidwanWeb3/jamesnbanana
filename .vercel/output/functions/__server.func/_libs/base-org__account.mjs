import { a as createStore, b as persist, d as createJSONStorage } from "./zustand.mjs";
import { u, B, _, h, y, T } from "./preact.mjs";
import { c as clsx } from "./clsx.mjs";
import { E as EventEmitter } from "./eventemitter3.mjs";
import { H as createPublicClient, D as http, I as createBundlerClient, J as base$1, K as avalanche, L as arbitrum, M as polygon, N as mainnet, O as bsc, P as zora, Q as optimism, T as baseSepolia, V as sepolia, W as optimismSepolia, X as defineChain, Y as isAddress, Z as isHex, _ as hashTypedData, $ as hashMessage, n as numberToHex, a0 as slice$1, x as keccak256, E as toHex$2, a1 as waitForCallsStatus, a2 as stringToBytes, a3 as hexToBytes, a4 as toSmartAccount, a5 as entryPoint06Address, a6 as entryPoint06Abi, a7 as getUserOperationHash, a8 as encodeFunctionData, a9 as decodeFunctionData, aa as BaseError, ab as encodeAbiParameters, y as stringToHex, ac as size, ad as parseSignature, ae as encodePacked, h as hexToString, af as hexToBigInt, ag as getCode, r as readContract, ah as pad, ai as decodeAbiParameters, aj as isAddressEqual, ak as hexToNumber, m as multicall$1, g as getAddress, al as chains, F as parseUnits, am as decodeEventLog, z as formatUnits } from "./viem.mjs";
import { c as createStore$1, s as set, d as del, g as get$1 } from "./idb-keyval.mjs";
import { K as slice, L as toHex, M as getSignPayload, N as sign$1, O as toHex$1, P as createKeyPair, Q as fromHex, R as toDerBytes } from "./ox.mjs";
import { C as CdpClient } from "./coinbase__cdp-sdk.mjs";
import "./react.mjs";
import "./noble__curves.mjs";
import "./@noble/hashes.mjs";
import "node:crypto";
import "./abitype.mjs";
import "./zod.mjs";
import "./isows.mjs";
...
import "util";
import "./ws.mjs";
import "./bufferutil.mjs";
import "./node-gyp-build.mjs";
import "./utf-8-validate.mjs";
import "./adraffy__ens-normalize.mjs";
import "./scure__bip32.mjs";
import "./scure__base.mjs";
import "./noble__ciphers.mjs";
import "./scure__bip39.mjs";
import "./md5.mjs";
import "./crypt.mjs";
import "./charenc.mjs";
...
import "./combined-stream.mjs";
import "./delayed-stream.mjs";
import "./mime-types.mjs";
import "./mime-db.mjs";
import "./asynckit.mjs";
import "./es-set-tostringtag.mjs";
import "./get-intrinsic.mjs";
import "./es-object-atoms.mjs";
import "./es-errors.mjs";
import "./math-intrinsics.mjs";
import "./gopd.mjs";
import "./es-define-property.mjs";
import "./has-symbols.mjs";
import "./get-proto.mjs";
import "./dunder-proto.mjs";
import "./call-bind-apply-helpers.mjs";
import "./function-bind.mjs";
import "./hasown.mjs";
import "./has-tostringtag.mjs";
import "./proxy-from-env.mjs";
import "http2";
import "./follow-redirects.mjs";
import "assert";
import "./debug.mjs";
import "./ms.mjs";
import "tty";
import "./supports-color.mjs";
import "./has-flag.mjs";
import "./axios-retry.mjs";
import "./is-retry-allowed.mjs";
import "./uncrypto.mjs";
import "./jose.mjs";
import "./bs58.mjs";
import "./base-x.mjs";
import "./solana__keys.mjs";
import "./solana__assertions.mjs";
import "./solana__errors.mjs";
import "./solana-program__system.mjs";
import "./solana__codecs-core.mjs";
import "./solana__codecs-data-structures.mjs";
import "./solana__codecs-numbers.mjs";
import "./solana__instructions.mjs";
import "./solana__signers.mjs";
import "./solana-program__token.mjs";
import "./solana__accounts.mjs";
import "./solana__codecs-strings.mjs";
import "./solana__addresses.mjs";
import "./solana__options.mjs";
import "./solana__rpc.mjs";
import "./solana__rpc-api.mjs";
import "./solana__rpc-spec.mjs";
import "./solana__rpc-spec-types.mjs";
import "./solana__rpc-transformers.mjs";
import "./solana__functional.mjs";
import "./solana__rpc-transport-http.mjs";
import "./solana__fast-stable-stringify.mjs";
import "./solana__transactions.mjs";
import "./solana__transaction-messages.mjs";
import "./solana__rpc-types.mjs";
...
function createStoreInstance(options) {
  ...
  if (shouldPersist) {
    return createStore(persist(storeCreator, {
      name: storageName,
...
const sdkstore = createStoreInstance({ persist: true });
function createStoreHelpers(storeInstance) {
  return {
    subAccountsConfig: {
    ...
    spendPermissions: {
      ...
      set: (spendPermissions2) => {
        storeInstance.setState({ spendPermissions: spendPermissions2 });
      },
      clear: () => {
        storeInstance.setState({
          spendPermissions: []
    ...
    chains: {
      ...
      set: (chains2) => {
        storeInstance.setState({ chains: chains2 });
      },
      clear: () => {
        storeInstance.setState({
          chains: []
    ...
    keys: {
      get: (key) => storeInstance.getState().keys[key],
      set: (key, value) => {
    ...
    config: {
      ...
      set: (config2) => {
        storeInstance.setState((state) => ({ config: { ...state.config, ...config2 } }));
      }
    }
  };
}
const globalStoreHelpers = createStoreHelpers(sdkstore);
globalStoreHelpers.subAccountsConfig;
globalStoreHelpers.subAccounts;
const spendPermissions = globalStoreHelpers.spendPermissions;
globalStoreHelpers.account;
globalStoreHelpers.chains;
globalStoreHelpers.keys;
const config = globalStoreHelpers.config;
const store = {
  ...sdkstore,
  ...globalStoreHelpers,
  persist: sdkstore.persist
};
...
function logEvent(name2, event, importance) {
  if (typeof window !== "undefined" && window.ClientAnalytics) {
    window.ClientAnalytics?.logEvent(name2, {
      ...event,
...
function defineChainConfig(chainId, rpcUrl, options) {
  ...
  const name2 = nativeCurrency?.name ?? viemChain?.name ?? "";
...
async function removeCryptoKey() {
  ...
  await storage.removeItem(slice(toHex(keypair.publicKey), 1));
...
function validateDataSuffix$1(dataSuffix) {
  if (!isHex(dataSuffix)) {
...
function makeDataSuffix({ attribution, dappOrigin }) {
  ...
  if ("dataSuffix" in attribution && typeof attribution.dataSuffix === "string") {
    return validateDataSuffix$1(attribution.dataSuffix);
  }
  return;
}
...
function convertCredentialToJSON({ webauthn, signature, id }) {
  ...
  return {
    ...
    response: {
      ...
      signature: arrayBufferToBase64Url(toDerBytes(signatureRaw))
    },
...
function validateGasLimitOverrides(calls) {
  for (let i = 0; i < calls.length; i++) {
    const gasLimitOverride = calls[i].capabilities?.gasLimitOverride;
    if (gasLimitOverride) {
      const { value } = gasLimitOverride;
      if (!value || !isHex(value)) {
        throw standardErrors.rpc.invalidParams(`gasLimitOverride.value must be a hex string at call index ${i}`);
      }
      const gasLimit = hexToBigInt(value);
      if (gasLimit === 0n) {
        throw standardErrors.rpc.invalidParams(`gasLimitOverride.value cannot be zero at call index ${i}`);
      }
    }
  }
}
    ...
    try {
      switch (args.method) {
        ...
        case "wallet_sendCalls": {
          ...
          const calls = args.params[0].calls;
...
async function handleAddSubAccountOwner({ ownerAccount, globalAccountRequest, chainId }) {
  ...
  const globalAccount = account.accounts?.find((account2) => account2.toLowerCase() !== subAccount?.address.toLowerCase());
...
async function aggregateGasLimitOverrides({ calls, client, subAccountAddress }) {
  const hasAnyOverride = calls.some((call) => call.capabilities && "gasLimitOverride" in call.capabilities && call.capabilities.gasLimitOverride?.value);
  if (!hasAnyOverride) {
    return void 0;
  }
  const gasLimits = await Promise.all(calls.map(async (call) => {
    const override = call.capabilities?.gasLimitOverride?.value;
    if (override) {
  ...
  const inputDataOverhead = calls.reduce((sum, call) => {
    const dataLength = call.data ? BigInt((call.data.length - 2) / 2) : 0n;
...
const logHandshakeStarted = ({ method, correlationId, isEphemeral = false }) => {
  const config2 = store.subAccountsConfig.get();
...
const logHandshakeError = ({ method, correlationId, errorMessage, isEphemeral = false }) => {
  const config2 = store.subAccountsConfig.get();
...
const logHandshakeCompleted = ({ method, correlationId, isEphemeral = false }) => {
  const config2 = store.subAccountsConfig.get();
...
const logRequestStarted$1 = ({ method, correlationId, isEphemeral = false }) => {
  const config2 = store.subAccountsConfig.get();
...
const logRequestError$1 = ({ method, correlationId, errorMessage, isEphemeral = false }) => {
  const config2 = store.subAccountsConfig.get();
...
const logRequestCompleted = ({ method, correlationId, isEphemeral = false }) => {
  const config2 = store.subAccountsConfig.get();
...
function withHandshakeMeasurement(getOptions, handler) {
  return async (args) => {
...
function withSignerRequestMeasurement(getOptions, handler) {
  return async (args) => {
    const options = getOptions();
    const correlationId = correlationIds.get(args);
    const measurementParams = {
    ...
    logRequestStarted$1(measurementParams);
    try {
...
class Signer {
  ...
  constructor(params) {
    ...
    const { account, chains: chains2 } = this.storeInstance.getState();
  ...
  handshake = withHandshakeMeasurement(() => ({ isEphemeral: this.isEphemeral }), async (args) => {
    const correlationId = correlationIds.get(args);
  ...
  request = withSignerRequestMeasurement(() => ({ isEphemeral: this.isEphemeral }), async (request) => {
    ...
    switch (request.method) {
      ...
      case "coinbase_fetchPermissions": {
        ...
        this.storeHelpers.spendPermissions.set(permissions.permissions.map((permission) => ({
          ...permission,
  ...
  async handleResponse(request, decrypted) {
    ...
    switch (request.method) {
      ...
      case "wallet_connect": {
        ...
        const accounts = response.accounts.map((account2) => account2.address);
        this.accounts = accounts;
        this.storeHelpers.account.set({
          accounts
        });
        ...
        if (spendPermissions2 && "permissions" in spendPermissions2) {
          this.storeHelpers.spendPermissions.set(spendPermissions2?.permissions);
        }
  ...
  async decryptResponseMessage(message) {
    ...
    if (availableChains) {
      ...
      this.storeHelpers.chains.set(chains2);
  ...
  async addSubAccount(request) {
    ...
    if (cachedSubAccount?.address) {
      ...
      if (shouldUseCache) {
        this.accounts = subAccountsConfig?.defaultAccount === "sub" ? prependWithoutDuplicates(this.accounts, cachedSubAccount.address) : appendWithoutDuplicates(this.accounts, cachedSubAccount.address);
        this.callback?.("accountsChanged", this.accounts);
    ...
    if (Array.isArray(request.params) && request.params.length > 0 && request.params[0].account && request.params[0].account.type === "create") {
      ...
      if (request.params[0].account.keys && request.params[0].account.keys.length > 0) {
        ...
        const config2 = this.storeHelpers.subAccountsConfig.get() ?? {};
  ...
  async sendRequestToSubAccountSigner(request) {
    const subAccount = this.storeHelpers.subAccounts.get();
    const subAccountsConfig = this.storeHelpers.subAccountsConfig.get();
    const config2 = this.storeHelpers.config.get();
    ...
    if (["eth_sendTransaction", "wallet_sendCalls"].includes(request.method)) {
      const subAccountsConfig2 = this.storeHelpers.subAccountsConfig.get();
      if (subAccountsConfig2?.funding === "spend-permissions") {
    ...
    try {
      ...
      const subAccountsConfig2 = this.storeHelpers.subAccountsConfig.get();
      if (subAccountsConfig2?.funding === "manual") {
        throw error;
      }
      let errorObject;
      if (isViemError(error)) {
...
const logRequestStarted = ({ method, correlationId, isEphemeral = false }) => {
...
const logRequestError = ({ method, correlationId, errorMessage, isEphemeral = false }) => {
...
const logRequestResponded = ({ method, correlationId, isEphemeral = false }) => {
...
const logGetInjectedProviderError = ({ errorMessage }) => {
...
function withMeasurement(options, handler) {
  return async (args) => {
...
class BaseAccountProvider extends ProviderEventEmitter {
  ...
  request = withMeasurement({ isEphemeral: false }, async (args) => {
    try {
...
function initializeTelemetryOnce() {
...
const fetchPermission = withTelemetry(fetchPermissionFn);
...
const getHash = withTelemetry(getHashFn);
async function multicall(client, config2) {
  ...
  try {
    const results = await multicall$1(client, {
...
const getPermissionStatusFn = async (permission, options) => {
...
const getPermissionStatus = withTelemetry(getPermissionStatusFn);
...
const prepareRevokeCallData = withTelemetry(prepareRevokeCallDataFn);
const ERC20_TRANSFER_ABI$1 = [
  {
    name: "transfer",
    type: "function",
    stateMutability: "nonpayable",
...
const prepareSpendCallDataFn = async (permission, amount, recipient, options) => {
...
const prepareSpendCallData = withTelemetry(prepareSpendCallDataFn);
const TOKENS = {
  USDC: {
    decimals: 6,
    addresses: {
...
function createCdpClientOrThrow(options, context) {
  try {
...
async function getExistingSmartWalletOrThrow(cdpClient, walletName, context) {
  try {
...
async function sendUserOpAndWait(networkSmartWallet, calls, paymasterUrl, timeoutSeconds, context) {
  try {
...
async function charge(options) {
  const { id, amount, testnet = false, cdpApiKeyId, cdpApiKeySecret, cdpWalletSecret, walletName = "subscription owner", paymasterUrl = process.env.PAYMASTER_URL, recipient, rpcUrl } = options;
...
You can get these credentials from https://portal.cdp.coinbase.com/projects/api-keys`);
  ...
  try {
    ...
    return {
      ...
      // Include EOA address for reference
    };
  } catch (error) {
    const errorMessage = error instanceof Error ? error.message : String(error);
...
class EphemeralSigner extends Signer {
  ...
  request = withSignerRequestMeasurement(() => ({ isEphemeral: this.isEphemeral }), async (request) => {
    switch (request.method) {
      ...
      case "wallet_sign":
        return this.sendRequestToPopup(request);
      default:
        throw standardErrors.provider.unauthorized(`Method '${request.method}' is not supported by ephemeral signer`);
    }
  });
  // No-op handleResponse - ephemeral signer doesn't update state
  async handleResponse(_request, decrypted) {
    const result = decrypted.result;
    if ("error" in result)
      throw result.error;
    return result.value;
...
class EphemeralBaseAccountProvider extends ProviderEventEmitter {
  communicator;
  signer;
  ephemeralStore;
  constructor({ metadata, preference: { walletUrl, ...preference } }) {
  ...
  request = withMeasurement({ isEphemeral: true }, async (args) => {
    try {
      switch (args.method) {
        case "wallet_sendCalls":
        case "wallet_sign": {
        ...
        case "eth_chainId": {
          const result = hexStringFromNumber(1);
          return result;
        }
        default: {
          throw standardErrors.provider.unauthorized(`Method '${args.method}' is not supported by ephemeral provider. Ephemeral providers only support: wallet_sendCalls, wallet_sign, wallet_getCallsStatus`);
        }
      }
    } catch (error) {
      const { code } = error;
...
function initializeEphemeralOnce() {
  if (ephemeralInitialized)
    return;
  ephemeralInitialized = true;
  void checkCrossOriginOpenerPolicy();
}
function initializeEphemeralTelemetryOnce() {
  if (ephemeralTelemetryInitialized)
    return;
  ephemeralTelemetryInitialized = true;
  void loadTelemetryScript();
}
const paymentQueue = /* @__PURE__ */ new Map();
function getQueueKey({ testnet, walletUrl }) {
  const network = testnet ? "testnet" : "mainnet";
  return `payment:${network}:${walletUrl ?? "default"}`;
}
function createEphemeralSDK({ chainId, walletUrl, telemetry = true, dataSuffix }) {
  ...
  const provider = new EphemeralBaseAccountProvider({
    ...
    preference: {
      telemetry,
      walletUrl,
      attribution: dataSuffix ? { dataSuffix } : void 0
    }
  });
  return {
...
async function executePaymentWithProvider(provider, requestParams) {
...
async function executePaymentWithSDK(requestParams, testnet, walletUrl, telemetry = true, dataSuffix) {
...
function buildSendCallsRequest(transferData, testnet, payerInfo, dataSuffix) {
  const network = testnet ? "baseSepolia" : "base";
  const chainId = CHAIN_IDS[network];
...
function translatePaymentToSendCalls(recipient, amount, testnet, payerInfo, dataSuffix) {
...
function validateDataSuffix(dataSuffix) {
  if (!isHex(dataSuffix)) {
    throw new Error("Invalid dataSuffix: expected a 0x-prefixed hex string");
  }
  return dataSuffix;
...
async function pay(options) {
  const { amount, to, dataSuffix, testnet = false, payerInfo, walletUrl, telemetry = true } = options;
  const correlationId = crypto.randomUUID();
  if (telemetry) {
  ...
  try {
    ...
    if (dataSuffix !== void 0) {
      validateDataSuffix(dataSuffix);
    }
    const requestParams = translatePaymentToSendCalls(normalizedAddress, amount, testnet, payerInfo, dataSuffix);
    const executionResult = await executePaymentWithSDK(requestParams, testnet, walletUrl, telemetry, dataSuffix);
    if (telemetry) {
