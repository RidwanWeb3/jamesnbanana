import { b as transformEncoder, f as fixEncoderSize, d as combineCodec, e as fixDecoderSize } from "./solana__codecs-core.mjs";
import { a as getBase58Encoder, b as getBase58Decoder } from "./solana__codecs-strings.mjs";
import { S as SolanaError, l as SOLANA_ERROR__ADDRESSES__STRING_LENGTH_OUT_OF_RANGE, m as SOLANA_ERROR__ADDRESSES__INVALID_BYTE_LENGTH, n as isSolanaError, o as SOLANA_ERROR__ADDRESSES__FAILED_TO_FIND_VIABLE_PDA_BUMP_SEED, p as SOLANA_ERROR__ADDRESSES__MAX_NUMBER_OF_PDA_SEEDS_EXCEEDED, q as SOLANA_ERROR__ADDRESSES__MAX_PDA_SEED_LENGTH_EXCEEDED, r as SOLANA_ERROR__ADDRESSES__INVALID_SEEDS_POINT_ON_CURVE } from "./solana__errors.mjs";
import { a as assertDigestCapabilityIsAvailable } from "./solana__assertions.mjs";
...
export {
  address as a,
  getAddressEncoder as b,
  getProgramDerivedAddress as c,
  getAddressDecoder as d,
  getAddressComparator as g,
  isAddress as i
};
