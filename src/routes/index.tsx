          ...
          <div className="relative grid md:grid-cols-2 gap-8 p-6 md:p-14">
            <div>
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                <a href="#" className="rounded-full bg-[color:var(--orange-accent)] text-white px-6 py-3 font-extrabold shadow-cute hover:scale-105 transition opacity-70 cursor-not-allowed">🛒 Coming Soon</a>
                <a href="#" className="rounded-full bg-[color:var(--leaf)] text-white px-6 py-3 font-extrabold shadow-cute hover:scale-105 transition opacity-70 cursor-not-allowed">📈 Coming Soon</a>
